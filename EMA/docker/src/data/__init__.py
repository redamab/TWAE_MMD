...
data processing pipeline for Transformer Wasserstein Autoencoder 
...
# Module metadata
__version__ = "2.0.0"
__author__ = "Reda Data Pipeline - Fixed"
__description__ = "processing pipeline for TWAE-MMD antimicrobial peptide generation"
