"""
TWAE-MMD Model Configuration - 1.5M Parameters with Latent Space Integration
Optimized for >97% accuracy without overfitting on antimicrobial peptide sequences

This configuration is specifically tuned for:
- 62K training samples (peptide sequences)
- 11K validation samples
...
class TWAEMMDConfig:
    ...
    # ===== Model Architecture (1.5M Parameters) =====
    ...
    # ===== Latent Space Configuration (NEW) =====
    ...
    # ===== Regularization (Enhanced for 1.5M params) =====
    ...
    # ===== Loss Weights (Optimized for 1.5M params) =====
