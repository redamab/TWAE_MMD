"""
🚀 LSBO-GUIDED TWAE-MMD TRAINER - COMPLETE VERSION
==================================================
    ...
    def train(self, num_epochs: int = 100):
        ...
        for epoch in range(num_epochs):
            ...
            if val_acc > self.best_val_accuracy:
                ...
                checkpoint_path = self.checkpoint_dir / f'best_model_epoch_{epoch+1:03d}_acc_{val_acc:.4f}.keras'
